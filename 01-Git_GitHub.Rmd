...
[Luego de terminar de hacer el Fork](#terminar_fork) en la lista de repositorios veremos los repositorios que se llaman igual, pero indicando a que perfil de GitHub es cada uno.
...
<p>Ahora podemos repetir los pasos anteriores ([desde el 4 en adelante](#paso4))</p>
<details><summary><em>Observación</em></summary>
<ul style="list-style-type:none"><li>
<p>[Luego de terminar de hacer el Fork](#terminar_fork), en la lista de repositorios veremos solo un repositorio (con el nombre del repositorio al que le hicimos el Fork) indicando pertenece a nuestro perfil personal de GitHub.</p>
...
8. Nos aparecerá la siguiente ventana, donde podemos escoger entre dos opciones.
<div></div>
...
9. Con esto ya tenemos nuestro nuestro `Fork` del repositorio listo para usarlo.
